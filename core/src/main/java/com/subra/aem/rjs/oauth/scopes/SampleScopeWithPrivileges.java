 ...
 */
@Component(service = Scope.class, immediate = true)
...
public class SampleScopeWithPrivileges implements ScopeWithPrivileges {
    public static final String WRITE_DAM_SCOPE_NAME = "test_workflow";
    public static final String BASE_PATH = "/var/workflow/instances";
    /**
